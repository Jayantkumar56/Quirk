...
namespace Quirk {
	...
	public:
		...
		void Init(View<Window> window, ConstView<GraphicalContext> context);
		void Terminate();
	...
	private:
		void InitForOpenGL(View<Window> window, ConstView<GraphicalContext> context);

	private:
		ImGuiContext* m_ImguiContext = nullptr;
        ConstView<GraphicalContext> m_GraphicalContext;
	};
