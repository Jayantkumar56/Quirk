...
namespace Quirk {
	...
	public:
		...
		virtual inline void DrawIndexed(Ref<RHI::VertexArray>& vertexArray, uint32_t indicesCount) override;
		virtual inline void DrawIndexedInstanced(Ref<RHI::VertexArray>& vertexArray, uint32_t noOfInstances) override;
